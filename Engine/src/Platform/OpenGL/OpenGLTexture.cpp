...
namespace Engine
{
  // If there is no file, use this constructor
  ...
  // If there is a file, use this constructor
    ...
    : m_Path(path)
  {
    ...
    // Textures are imported upside-down by default
  ...
  void OpenGLTexture2D::SetData(void* data, uint32_t size)
  {
    ...
    EN_CORE_ASSERT(size == m_Width * m_Height * numBytes, "Texture data is incomplete!");
